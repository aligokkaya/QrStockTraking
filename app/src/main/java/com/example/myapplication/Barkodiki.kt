...
class Barkodiki : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_barkodiki)
    ...
    {
        detector = BarcodeDetector.Builder(this@Barkodiki).build()
        cameraSource = CameraSource.Builder(this@Barkodiki,detector).setAutoFocusEnabled(true).build()
    ...
    private val processor = object : Detector.Processor<Barcode>{
        ...
        override fun receiveDetections(p0: Detector.Detections<Barcode>?) {
            if(p0 != null && p0.detectedItems.isNotEmpty())
            {
                ...
                val context = this
                val db = DBHelper(this@Barkodiki,null,null,1)
                val name = textScanResult.text.toString()
                val cont=db.querr(textScanResult.text.toString())
